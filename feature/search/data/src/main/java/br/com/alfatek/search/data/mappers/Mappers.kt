package br.com.alfatek.search.data.mappers

import br.com.alfatek.search.data.model.RecipeDTO
...
fun RecipeDTO.toDomain(): RecipeDetails {
  return   RecipeDetails(
        ...
        ingredientsPair = this.getIngredientPairsWithMeasure()
    )
}

fun RecipeDTO.getIngredientPairsWithMeasure(): List<Pair<String, String>> {
